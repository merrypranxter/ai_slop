...
- `01-principles/` — philosophy, structured-instability rules, epistemic discipline.
...
- `08-reference/` — provenance, source audit, glossary, archive policy, lenses, disputed/superseded claims.
